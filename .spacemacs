  ...
  (setq-default
   ...
   '(
     ...
     (shell :variables
            ...
            shell-default-shell 'ansi-term ;; optional for windows. if problems accure - replace with' 'eshel
...
This funcion defines the environment variables for your Emacs session. By
...
(defun dotspacemacs/user-config ()
  ...
  ;; Modern smooth touchpad scrolling (Emacs 29+)
  ...
  ;; Reduce LSP lag during scrolling
